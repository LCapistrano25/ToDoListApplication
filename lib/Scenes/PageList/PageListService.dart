  ...
  List<Map<String, dynamic>> _ensureList(int idList, String listType) {
    return _listItems.putIfAbsent(idList, () {
      final initial = idList == 1
          ? [
              {'id': 1, 'title': 'Fazer Trabalho de matemática', 'type': listType, 'quantity': 2, 'value': '15.90'},
              {'id': 2, 'title': 'Item 2', 'type': listType, 'quantity': 1, 'value': '8.00'},
              {'id': 3, 'title': 'Item 3', 'type': listType, 'quantity': 5, 'value': '40.00'},
            ]
          : <Map<String, dynamic>>[];
